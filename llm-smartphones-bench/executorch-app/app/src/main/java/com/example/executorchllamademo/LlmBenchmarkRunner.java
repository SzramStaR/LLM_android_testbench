...
// Dodaj sprawdzenie
    if (tokenizerPath == null || tokenizerPath.isEmpty()) {
      Log.e("LlmBenchmarkRunner", "Tokenizer path is null or empty!");
      mTextView.setText("Error: Tokenizer not loaded");
      return;
    }

    File tokenizerFile = new File(tokenizerPath);
    if (!tokenizerFile.exists()) {
      Log.e("LlmBenchmarkRunner", "Tokenizer file does not exist: " + tokenizerPath);
      mTextView.setText("Error: Tokenizer file not found at " + tokenizerPath);
    }
