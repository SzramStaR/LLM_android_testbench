...
public class SettingsActivity extends AppCompatActivity {
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    ViewCompat.setOnApplyWindowInsetsListener(
        requireViewByIdCompat(R.id.main),
        (v, insets) -> {
  ...
  private void setupSettings() {
    mBackendTextView = requireViewByIdCompat(R.id.backendTextView);
    mModelTextView = requireViewByIdCompat(R.id.modelTextView);
    mTokenizerTextView = requireViewByIdCompat(R.id.tokenizerTextView);
    mModelTypeTextView = requireViewByIdCompat(R.id.modelTypeTextView);
    ImageButton backendImageButton = requireViewByIdCompat(R.id.backendImageButton);
    ImageButton modelImageButton = requireViewByIdCompat(R.id.modelImageButton);
    ImageButton tokenizerImageButton = requireViewByIdCompat(R.id.tokenizerImageButton);
    ImageButton modelTypeImageButton = requireViewByIdCompat(R.id.modelTypeImageButton);
    mSystemPromptEditText = requireViewByIdCompat(R.id.systemPromptText);
    mUserPromptEditText = requireViewByIdCompat(R.id.userPromptText);
    loadSettings();
  ...
  private void setupLoadModelButton() {
    mLoadModelButton = requireViewByIdCompat(R.id.loadModelButton);
  ...
  private void setupClearChatHistoryButton() {
    Button clearChatButton = requireViewByIdCompat(R.id.clearChatButton);
  ...
  private void setupTemperatureSettings() {
    ...
    EditText temperatureEditText = requireViewByIdCompat(R.id.temperatureEditText);
  ...
  private void setupSystemPromptSettings() {
    ...
    ImageButton resetSystemPrompt = requireViewByIdCompat(R.id.resetSystemPrompt);
  ...
  private void setupUserPromptSettings() {
    ...
    ImageButton resetUserPrompt = requireViewByIdCompat(R.id.resetUserPrompt);
  ...
  private void setXNNPACKSettingMode() {
    requireViewByIdCompat(R.id.modelLayout).setVisibility(View.VISIBLE);
    requireViewByIdCompat(R.id.tokenizerLayout).setVisibility(View.VISIBLE);
    requireViewByIdCompat(R.id.parametersView).setVisibility(View.VISIBLE);
    requireViewByIdCompat(R.id.temperatureLayout).setVisibility(View.VISIBLE);
    mModelFilePath = "";
    mTokenizerFilePath = "";
  }

  private void setMediaTekSettingMode() {
    requireViewByIdCompat(R.id.modelLayout).setVisibility(View.GONE);
    requireViewByIdCompat(R.id.tokenizerLayout).setVisibility(View.GONE);
    requireViewByIdCompat(R.id.parametersView).setVisibility(View.GONE);
    requireViewByIdCompat(R.id.temperatureLayout).setVisibility(View.GONE);
